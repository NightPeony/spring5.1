...
public class XmlBeanFactory extends DefaultListableBeanFactory {
	...
	//创建XmlBeanFactory时候  传入一个this 这个this同时还代表者注册器DefaultListableBeanFactory
	//将请求委托给XmlBeanDefinitionReader  又将自身注入  自身代表着什么?
	//自身就是个工厂  也是个注册器
	...
	public XmlBeanFactory(Resource resource, BeanFactory parentBeanFactory) throws BeansException {
		//这一步初始化父类  可以理解为初始化基本资源  后续要用1.工厂，虽然为空，但是思想上有了2.三个解决自动依赖的类
